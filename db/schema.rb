...
ActiveRecord::Schema.define(version: 20201103140357) do
  ...
  create_table "attendance_custom_tickets", force: :cascade do |t|
    ...
    t.boolean  "external_validate",      default: false
    t.datetime "external_validate_at"
  end
  ...
  create_table "attendance_external_users", force: :cascade do |t|
    t.string   "name"
    t.string   "cpf"
    t.string   "email"
  ...
  create_table "candidate_cadastre_pendencies", force: :cascade do |t|
    t.integer  "cadastre_id"
    t.integer  "category_id"
    t.integer  "user_id"
    ...
    t.text     "resolved_feedback"
    t.string   "resolved_document"
    ...
    t.index ["cadastre_id"], name: "index_sihab.candidate_cadastre_pendencies_on_cadastre_id", using: :btree
    t.index ["category_id"], name: "index_sihab.candidate_cadastre_pendencies_on_category_id", using: :btree
    t.index ["code"], name: "index_sihab.candidate_cadastre_pendencies_on_code", unique: true, using: :btree
  end
  ...
  create_table "candidate_enterprise_cadastres", force: :cascade do |t|
    ...
    t.date     "inactive_at"
    t.integer  "father_id"
    t.integer  "dossier_situation_id",          default: 1
    t.text     "dossier_situation_observation"
  ...
  create_table "candidate_pendency_categories", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  ...
  create_table "candidate_subscribe_dependents", force: :cascade do |t|
    t.integer  "subscribe_id"
    t.string   "name"
    t.string   "cpf"
    t.string   "rg"
    t.string   "rg_org"
    t.string   "rg_state_id"
    t.date     "rg_emission_date"
    t.date     "born"
  ...
  create_table "candidate_subscribes", force: :cascade do |t|
    ...
    t.string   "mother_name"
    t.integer  "civil_state_id"
    t.boolean  "terms_one",                 default: false
    t.boolean  "terms_two",                 default: false
    t.boolean  "terms_three",               default: false
    t.boolean  "terms_four",                default: false
    t.boolean  "terms_five",                default: false
    t.string   "password"
    t.string   "remember_token"
  ...
  create_table "cpl_concurrence_notice_user_credentials", force: :cascade do |t|
  ...
  create_table "cpl_concurrence_notice_user_resources", force: :cascade do |t|
    t.integer  "notice_id"
    t.integer  "notice_user_id"
    t.text     "content"
    t.boolean  "status",         default: true
  ...
  create_table "entity_provisional_candidates", force: :cascade do |t|
    t.integer  "cadastre_id"
    t.integer  "entity_id"
    t.integer  "old_id"
    t.datetime "created_at",  null: false
  ...
  create_table "form_mestre_darmas_regularizations", force: :cascade do |t|
    t.integer  "unit_id"
    t.string   "address"
    t.string   "name"
    t.string   "nationality"
  ...
  create_table "helpdesk_type_subjects", force: :cascade do |t|
    t.string   "name"
    t.boolean  "status",         default: true
    t.integer  "ticket_type_id"
    t.datetime "created_at",                    null: false
  ...
  create_table "logo_questions", force: :cascade do |t|
    t.integer  "choice_id"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "protocol_volunteers", force: :cascade do |t|
    t.string   "box"
    t.string   "document_number"
    t.string   "name"
    t.string   "cpf"
  ...
  create_table "sefaz_allotments", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["id"], name: "idx_allotment", unique: true, using: :btree
