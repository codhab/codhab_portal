Schedule::Engine.routes.draw do
  ...
  namespace :finance, path: 'financeiro' do
  ...
  namespace :candidate, path: 'candidato' do
    get   'new_verify', path: 'verificacao', to: 'verifications#new', as: 'new_verification'
    post  'create_verify', path: 'verificacao', to: 'verifications#create', as: 'verification'
