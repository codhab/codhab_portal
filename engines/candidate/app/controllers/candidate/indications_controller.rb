  ...
  class IndicationsController < ApplicationController
    ...
    def index
      ...
      if params[:by_enterprise].present? || params[:by_cpf].present?
        @cadastres = apply_scopes(Firm::EnterpriseCadastre.includes(:cadastre)).paginate(:page => params[:page], :per_page => 20)
    ...
    def steps
      ...
      @steps = Firm::Step.where(enterprise_id: enterprise_id)
    ...
    def allotments
      ...
      @allotments = Firm::Allotment.where(step_id: step_id)
