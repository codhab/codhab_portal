module Candidate
  module View
    class IndicatedContemplated < ActiveRecord::Base
      self.table_name = 'extranet.indicated_contemplateds'
      ...
      belongs_to :enterprise_cadastre,foreign_key: :indication_id,  primary_key: :id,  class_name: "Firm::EnterpriseCadastre"
