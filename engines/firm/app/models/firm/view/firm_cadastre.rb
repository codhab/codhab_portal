  ...
  module View
    class FirmCadastre < ActiveRecord::Base
      self.table_name = 'extranet.firm_cadastres'
       ...
       belongs_to :enterprise, class_name: "Firm::Enterprise", foreign_key: "enterprise_id"
       belongs_to :enterprise_cadastre_situation, class_name: "Firm::EnterpriseCadastreSituation", foreign_key: "enterprise_cadastre_status_id"
